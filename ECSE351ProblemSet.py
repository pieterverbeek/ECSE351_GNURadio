...
class ECSE351ProblemSet(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.relative_scale_dB = relative_scale_dB = 0
        ...
        self._relative_scale_dB_range = qtgui.Range(0, 60, 5, 0, 200)
        self._relative_scale_dB_win = qtgui.RangeWidget(self._relative_scale_dB_range, self.set_relative_scale_dB, "'relative_scale_dB'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._relative_scale_dB_win)
    ...
    def get_relative_scale_dB(self):
        return self.relative_scale_dB

    def set_relative_scale_dB(self, relative_scale_dB):
        self.relative_scale_dB = relative_scale_dB
